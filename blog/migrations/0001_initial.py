    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qq', models.CharField(max_length=20, null=True, verbose_name=b'QQ\xe5\x8f\xb7', blank=True)),
                ('mobile', models.CharField(max_length=11, unique=True, null=True, verbose_name=b'\xe6\x89\x8b\xe6\x9c\xba\xe5\x8f\xb7', blank=True)),
                ('url', models.CharField(max_length=100, null=True, verbose_name=b'\xe4\xb8\xaa\xe4\xba\xba\xe7\xbd\x91\xe7\xab\x99\xe7\xbd\x91\xe5\x9d\x80', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_publish', models.DateTimeField(default=django.utils.timezone.now, verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xb6\xe9\x97\xb4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(max_length=500, null=True, verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe6\x8f\x8f\xe8\xbf\xb0', blank=True)),
                ('content', models.TextField(verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe5\x86\x85\xe5\xae\xb9')),
                ('url', models.URLField(null=True, verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe9\x93\xbe\xe6\x8e\xa5', blank=True)),
                ('portal', models.ImageField(default=b'article/default.jpg', upload_to=b'article/%Y/%m', max_length=1000, blank=True, null=True, verbose_name=b'\xe6\x96\x87\xe7\xab\xa0\xe5\x9b\xbe\xe7\x89\x87')),
                ...
                ('is_recommed', models.BooleanField(default=False, verbose_name=b'\xe6\x98\xaf\xe5\x90\xa6\xe6\x8e\xa8\xe8\x8d\x90')),
                ('date_publish', models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name=b'\xe5\x8f\x91\xe8\xa1\xa8\xe6\x97\xb6\xe9\x97\xb4', blank=True)),
            ],
            options={
                'ordering': ['-date_publish'],
                'verbose_name': '\u6587\u7ae0',
                'verbose_name_plural': '\u6587\u7ae0',
                'permissions': [('can_view', '\u53ef\u4ee5\u770b\u6587\u7ae0'), ('can_add', '\u53ef\u4ee5\u589e\u52a0\u6587\u7ae0'), ('can_edit', '\u53ef\u4ee5\u7f16\u8f91\u6587\u7ae0'), ('can_delete', '\u80fd\u5220\u9664\u6587\u7ae0')],
            },
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('index', models.IntegerField(default=99, verbose_name=b'\xe6\x98\xbe\xe7\xa4\xba\xe9\xa1\xba\xe5\xba\x8f(\xe4\xbb\x8e\xe5\xb0\x8f\xe5\x88\xb0\xe5\xa4\xa7)')),
            ],
            options={
                'ordering': ['index', 'id'],
                'verbose_name': '\u5206\u7c7b',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_publish', models.DateTimeField(default=django.utils.timezone.now, verbose_name=b'\xe5\x8f\x91\xe5\xb8\x83\xe6\x97\xb6\xe9\x97\xb4')),
                ('index', models.IntegerField(default=99, verbose_name=b'\xe6\x8e\x92\xe5\x88\x97\xe9\xa1\xba\xe5\xba\x8f(\xe4\xbb\x8e\xe5\xb0\x8f\xe5\x88\xb0\xe5\xa4\xa7)')),
            ],
            options={
                'ordering': ['index', 'id'],
                'verbose_name': '\u53cb\u60c5\u94fe\u63a5',
